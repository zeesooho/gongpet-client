...
abstract class $SigunguItemCopyWith<$Res> {
  factory $SigunguItemCopyWith(
          SigunguItem value, $Res Function(SigunguItem) then) =
      _$SigunguItemCopyWithImpl<$Res, SigunguItem>;
  @useResult
  $Res call({String uprCd, String orgCd, String orgdownNm});
}
...
abstract class _$$SigunguItemImplCopyWith<$Res>
  ...
  factory _$$SigunguItemImplCopyWith(
          _$SigunguItemImpl value, $Res Function(_$SigunguItemImpl) then) =
...
class __$$SigunguItemImplCopyWithImpl<$Res>
  ...
  __$$SigunguItemImplCopyWithImpl(
      _$SigunguItemImpl _value, $Res Function(_$SigunguItemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SigunguItemImpl(
      uprCd: null == uprCd
          ? _value.uprCd
          : uprCd // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$SigunguItemImpl implements _SigunguItem {
  _$SigunguItemImpl(
      {required this.uprCd, required this.orgCd, required this.orgdownNm});
  ...
  @override
  String toString() {
    return 'SigunguItem(uprCd: $uprCd, orgCd: $orgCd, orgdownNm: $orgdownNm)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, uprCd, orgCd, orgdownNm);
  ...
  Map<String, dynamic> toJson() {
    return _$$SigunguItemImplToJson(
      this,
    );
  }
}
...
abstract class _SigunguItem implements SigunguItem {
  factory _SigunguItem(
      {required final String uprCd,
      required final String orgCd,
      required final String orgdownNm}) = _$SigunguItemImpl;
