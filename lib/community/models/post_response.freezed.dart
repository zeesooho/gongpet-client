...
abstract class $PostResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Post> posts, int total, int currentPage, int totalPages});
}
...
class _$PostResponseImpl implements _PostResponse {
  ...
  @override
  String toString() {
    return 'PostResponse(posts: $posts, total: $total, currentPage: $currentPage, totalPages: $totalPages)';
  }
...
abstract class _PostResponse implements PostResponse {
  factory _PostResponse(
      ...
      required final int totalPages}) = _$PostResponseImpl;
